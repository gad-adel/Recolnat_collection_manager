...
@ActiveProfiles("int")
@Slf4j
class ArticleResourceTest extends AbstractResourceDBTest {
    ...
    void addArticle() throws Exception {
        ...
        when(mediathequeService.savePicture(file)).thenReturn(new ResponseEntity<>(mediaDetailsOutput, HttpStatusCode.valueOf(HttpStatus.SC_SUCCESS)));
