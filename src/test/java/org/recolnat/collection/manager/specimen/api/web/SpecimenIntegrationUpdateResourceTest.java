...
import static org.recolnat.collection.manager.specimen.api.web.SpecimenRetrieveResourceTest.SPECIMEN_ID;
...
@ActiveProfiles("int")
class SpecimenIntegrationUpdateResourceTest extends AbstractResourceElasticTest {
