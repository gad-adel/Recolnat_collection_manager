...
INSERT INTO institution(id, code, name, mandatory_description, optional_description, logo_url, partner_type, created_by,
                        created_at, institution_id)
VALUES (2, 'CJBN', 'Conservatoire et jardins botaniques de Nancy', ' mandatory description CJBN', NULL, NULL,
        'DATA_PROVIDER', 'script', now(), 'afea161b-70bb-4cad-aa04-d20698f5721c');
...
INSERT INTO specimen(id, legacy_id, created_at, created_by, modified_by, modified_at, fk_id_collection, state,
                     nominative_collection)
values ('9c6ab9ea-d049-47b5-972c-18e7831bdd4e', 'legacy_id', '2022-03-25 12:22:30.965616', 'created_by', null, null,
        '8342cf1d-f202-4c10-9037-2e2406ce7331', 'VALID', 'Collection nominale 1');
...
(id, legacy_id, created_at, created_by, modified_by, modified_at, catalog_number, record_number, basis_of_record,
 ...
 fk_geo_id, fk_colevent_id, fk_other_id, collection_code, nominative_collection)
VALUES ('359eefe3-901a-4faf-bc3e-6f3fa266a465'::uuid, 'Passeriformes', '2022-08-10 17:27:53.309', 'zied', NULL, NULL,
        ...
        'VALID', NULL, NULL, NULL, NULL, 'Collection nominale 2');
