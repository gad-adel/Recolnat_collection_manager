...
VALUES (132, 'MNHN', 'Muséum National d''Histoire Naturelle', ' mandatory description MNHN', NULL, NULL, 'PARTNER',
        'script', now(), '50f4978a-da62-4fde-8f38-5003bd43ff65');

INSERT INTO collection (id, type_collection, institution_id, collection_name_fr,
                        collection_name_en, description_fr, description_en, fk_institution_id, collection_code)
VALUES ('8342cf1d-f202-4c10-9037-2e2406ce7332', 'h', 132, 'botanique', 'botanique',
        'Herbier de la Société des Lettres de l''Aveyron', '', '50f4978a-da62-4fde-8f38-5003bd43ff65', 'SLA2');

INSERT INTO collection (id, type_collection, institution_id, collection_name_fr,
                        collection_name_en, description_fr, description_en, fk_institution_id)
VALUES ('9a342a92-6fe8-48d3-984e-d1731c051667', 'IT', 132, 'Tunicier', 'Tunicates',
        'Tunicates collection (IT) of the Muséum national d''Histoire naturelle (MNHN - Paris)',
        'Tunicates collection (IT) of the Muséum national d''Histoire naturelle (MNHN - Paris)',
        '50f4978a-da62-4fde-8f38-5003bd43ff65');
...
VALUES ('50be8c08-ae37-42a2-8d16-8e75a27c294f', true, 0, 0, 'string', 'string', 'string', 'string', 'string', 'string',
        'string', 'string', true, true, 0, 0, 0, 0, 'string', true, 'string', true, 'string', 'string', 'string',
        'string', 'string', 'FRA', 'string', 'string', 'string', 'string');
...
INSERT INTO specimen (id, legacy_id, created_at, created_by, modified_by, modified_at,
...
VALUES ('70029074-fde4-4f85-b3fe-9e25e7bfd9ef', 'string', '2022-07-16 07:09:02.812912', 'respinsttest1', null, null,
        '12345', 'string', 'string', 'string', 'string', 'string', 'string', 'string', 'string', 'string', 'SLA',
        '8342cf1d-f202-4c10-9037-2e2406ce7332', 'VALID', '1e471187-8d58-4919-9332-895ffbefd22f',
        '50be8c08-ae37-42a2-8d16-8e75a27c294f', '7ba58534-5197-47f2-a8a8-5db4154b15d4');

INSERT INTO identification (id, current_determination, date_identified, error_message, identification_remarks,
...
VALUES ('83930a4a-521f-45c3-96d7-5abb55db24ad', true, '2022-07-13', 'string', 'string', 'true', 'string', 'string',
        'string', '70029074-fde4-4f85-b3fe-9e25e7bfd9ef');

INSERT INTO taxon (id, kingdom, phylum, taxon_class, taxon_order, sub_order, family, genus, sub_genus,
...
VALUES ('99457981-f96d-4875-80fe-09921543175e', 'string', 'string', 'string', 'string', '2022-07-13', 'string',
        ...
        'string', 'string', '70029074-fde4-4f85-b3fe-9e25e7bfd9ef');
...
VALUES ('0bc8f18a-10dd-4af6-86bf-aeb2af61fe09', 'string', 'string', 'string', 'string', 'string', 'string',
        '70029074-fde4-4f85-b3fe-9e25e7bfd9ef', 'string');
